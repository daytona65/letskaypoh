...
import { getVisitByIdData, getAllSeniorsData, checkTokenValid } from "../../api";
    ...
    <div className={"container"}>
      ...
      <div className={"confirmVisit"}>
        <div className={"thankYou"}>
          ...
          <h3>Thank you for visiting, {userName?.split(" ")[0]}!</h3>
        </div>
        <img className={"checkImg"} src={Check} />
        <Alert
          className="alert"
          description={
            "Please give some feedback on the visit to help us monitor the senior's wellbeing"
          }
          type="success"
        />
        ...
        <div className={"completeForm"} style={{ width: "100%" }}>
          ...
          >
            ...
            <Form.Item
              ...
              label="Anything that requires special attention?"
              name="health"
              rules={[
                {
                  required: false,
                  message: "Please input any notes / remarks!",
                },
              ]}
            >
              <TextArea />
            ...
            <h3 className={"formSection"}>
              Any services the senior requested for?
            </h3>
            ...
            <Form.Item
              style={{ marginTop: "2rem" }}
              label="Other services not listed above"
              name="others"
              rules={[
                {
                  required: false,
            ...
            <Form.Item
              style={{ marginTop: "2rem" }}
              label="Please elaborate on the services required"
              name="svcs"
              rules={[
                {
                  required: false,
            ...
            <Form.Item
              label="Visit Notes (eg what did you do, etc)"
              name="visitNotes"
              rules={[
                {
                  required: false,
            ...
            <Form.Item
              label="Any follow up actions required?"
              name="followUp"
              rules={[
                {
                  required: false,
